...
<div class="container">
  ...
  <table class="table table-hover">
    ...
    <?php
              ...
              $selection ="SELECT * FROM documento WHERE nome_documento LIKE '%$pesquisar%' LIMIT 5";
     ...
     <td><td> <button class="btn btn--radius-2 btn--green" name="editar" type="submit"> <a href="projecto/Editarform.php?id_documento=<?php echo $result['id_documento']; ?>" style="color:white;"> Editar </a></button></td></td>
